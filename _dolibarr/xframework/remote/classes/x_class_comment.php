	...
	class x_class_comment {
		...
		private function create_table() {
			$this->mysqlobj->query("CREATE TABLE IF NOT EXISTS `".$this->table."` (
											  ...
											  `target` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Target Name',
											  `targetid` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Target ID',
											  `name` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Autor Name',
											  `text` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Activitie Text',
