<?php
	...
	llxHeader("","Changelogs - Debug - Mitec");
	...
	$table->addColumn("refid", "Referenz", "left", 1, true, true);
	$table->addColumn("createdate", "Datum", "left", 1, true, true);
	$table->addColumn("username", "Benutzer", "left", 1, true, true);
	$table->addColumn("changesstring", "Änderungen", "left", 1, true, true);
