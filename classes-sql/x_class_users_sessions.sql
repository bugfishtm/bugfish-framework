...
-- Dumping structure for table bugfish.x_class_users_sessions
CREATE TABLE IF NOT EXISTS `x_class_users_sessions` (
  ...
  `session_key` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT 'Session Key',
  `is_active` tinyint(1) DEFAULT '0' COMMENT 'Key Status 1 - Active 0 - Inactive',
  `request_ip` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT 'Requested IP',
  PRIMARY KEY (`id`)
