...
-- Dumping structure for table bugfish.x_class_ipblacklist
CREATE TABLE IF NOT EXISTS `x_class_ipblacklist` (
  `id` int NOT NULL AUTO_INCREMENT COMMENT 'Unique ID',
  `failures` int DEFAULT NULL COMMENT 'Failures for this IP Address',
