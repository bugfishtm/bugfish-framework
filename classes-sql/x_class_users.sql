...
-- Dumping structure for table bugfish.x_class_users
CREATE TABLE IF NOT EXISTS `x_class_users` (
  ...
  `user_mail_shadow` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT 'Users Store for Mail if Renew',
