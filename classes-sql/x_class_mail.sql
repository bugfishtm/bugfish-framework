...
-- Dumping structure for table bugfish.x_class_mail
CREATE TABLE IF NOT EXISTS `x_class_mail` (
  ...
  `create_date` datetime DEFAULT CURRENT_TIMESTAMP COMMENT 'Creation Date',
