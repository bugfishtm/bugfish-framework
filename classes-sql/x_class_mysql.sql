...
-- Dumping structure for table bugfish.x_class_mysql
CREATE TABLE IF NOT EXISTS `x_class_mysql` (
  ...
  `date` datetime DEFAULT CURRENT_TIMESTAMP COMMENT 'Creation Date',
