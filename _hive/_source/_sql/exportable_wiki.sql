...
-- Dumping structure for table bugfish.exportable_wiki
CREATE TABLE IF NOT EXISTS `exportable_wiki` (
  ...
  `text` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT 'Content',
  ...
  `sec_cat` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT 'Sub Category Name',
  `blog_entry` tinyint(1) DEFAULT NULL COMMENT '1 - Sended to Blog',
  `draft` tinyint(1) DEFAULT '1' COMMENT '1 - Draft | 0 - Done ',
