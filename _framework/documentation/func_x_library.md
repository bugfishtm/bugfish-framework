...
| x_thumbnail_save($url,  $save_path = null, $width, $height) | Create Thumbnail from URL to Local JPG without returning Object |
...
---------------------------------
|EventBox Functions|Description|
|--|--|
...
---------------------------------
|CookieBanner Functions|Description|
|--|--|
