...
class x_class_user {    
	...
	## User Functions
	public function get($id){if(is_numeric($id)){$r = $this->mysql->query("SELECT * FROM ".$this->dt_users." WHERE id = '".$id."'");if($x=mysqli_fetch_array($r)){return $x;}}return false;}
	public function exists($id){if(!is_numeric($id)){return false;}$r = $this->mysql->query("SELECT * FROM ".$this->dt_users." WHERE id = '".$id."'");if($rrx = mysqli_fetch_array($r)){return true;}return false;}
	public function usernameExists($ref){$r = $this->mysql->query("SELECT * FROM ".$this->dt_users." WHERE LOWER(user_name) = \"".$this->f_tel($ref)."\"");if($rrx=mysqli_fetch_array($r)){return true;}return false;}
	public function usernameExistsActive($ref){$r = $this->mysql->query("SELECT * FROM ".$this->dt_users." WHERE LOWER(user_name) = \"".$this->f_tel($ref)."\" AND user_confirmed = 1");if($rrx = mysqli_fetch_array($r)){return true;}return false;}	
	public function refExists($ref){$r = $this->mysql->query("SELECT * FROM ".$this->dt_users." WHERE LOWER(".$this->login_field.") = \"".$this->f_tel($ref)."\"");if($rrx = mysqli_fetch_array($r)){return true;}return false;}
	public function refExistsActive($ref) {$r = $this->mysql->query("SELECT * FROM ".$this->dt_users." WHERE LOWER(".$this->login_field.") = \"".$this->f_tel($ref)."\" AND user_confirmed = 1");if($rrx = mysqli_fetch_array($r)){return true;}return false;}	
	public function mailExists($ref){$r = $this->mysql->query("SELECT * FROM ".$this->dt_users." WHERE LOWER(user_mail) = \"".$this->f_tel($ref)."\"");if($rrx=mysqli_fetch_array($r)){return true;}return false;}
	public function mailExistsActive($ref) {$r = $this->mysql->query("SELECT * FROM ".$this->dt_users." WHERE LOWER(user_mail) = \"".$this->f_tel($ref)."\" AND user_confirmed = 1");if($rrx = mysqli_fetch_array($r)){return true;}return false;}	
	...
	public function blocked_user($id){if(is_numeric($id)) {$r = $this->mysql->query("SELECT * FROM ".$this->dt_users." WHERE id = '".$id."'");if($x = mysqli_fetch_array($r)){if($x["user_blocked"] != 1){return false;}}}return true;}
	...
	public function confirmed_user($id){if(is_numeric($id)){$r = $this->mysql->query("SELECT * FROM ".$this->dt_users." WHERE id = '".$id."'");if($x = mysqli_fetch_array($r)){if($x["user_confirmed"] == 1){return true;}}}return false;}	
	...
	public function mail_edit($id, $newmail, $nointervall = false) {
		...
		if($this->mail_unique) { 
			...
			if($f=mysqli_fetch_array($r)){	$this->mc_request_code = 4; return 4; } 				
		}
